...
const Search = () => {
  ...
  return (
    <>
    <form className={`SearchInput flex justify-center items-center bg-[#364153] rounded-xl px-2 py-2 w-fit mx-auto mt-10 focus-within:outline focus-within:outline-[2px] focus-within:outline-[#3662E3]`}>
